...
concept_api_url = settings.base_url + "/orgs/MOH-KENYA/sources/PPB_NP/concepts/"
concept_mapping_api_url = settings.base_url + "/orgs/MOH-KENYA/sources/PPB_NP/mappings/"
...
def get_concept(concept_id):
    """Method to get existing concept details."""
    try:
        url = concept_api_url % concept_id
        data = {}
